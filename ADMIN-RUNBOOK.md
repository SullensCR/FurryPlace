...
3. Copy `FurryplaceEvent-1.0.0.jar` into `plugins` and start Leaf 26.2.
4. Confirm the console prints `FurryplaceEvent 1.0.0 está listo.`
...
3. Run `/furryplace template generate` and confirm the menu. This creates the default ground in `place-template`, captures it, and keeps players in the lobby while progress is shown.
